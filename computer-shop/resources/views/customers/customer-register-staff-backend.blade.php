                            ...
                            <div class="col-md-12">
                                ...
                                <form action="{{ url('customer/create') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input class="input" type="text" name="customerUsername"
                                    ...
                                    <hr>
                                    <div class="form-group">
                                        <input class="input" type="tel" name="customerPassword"
                                    ...
                                    <hr>
                                    <div class="form-group">
                                        <input class="input" type="tel" name="customerFullName"
                                        placeholder="Customer's full name">
                                        <span class="text-danger">
                                            @error('customerFullName')
                                                {{ $message }}
                                            @enderror
                                        </span>
                                    </div>
                                    ...
                                    <a href="/customer/index" class="btn btn-danger">Back</a>
                                </form>
                            </div>
                        </div>
            </main>
