                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <tfoot>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('customer/deleteI/'.$Customer->customerID)}}" class="btn btn-danger">Delete Customer</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <hr>
                                <a href="/customer/register-staff" class="btn btn-primary">Register new Customer</a>
                            </div>
                        </div>
                    </div>
                </main>
