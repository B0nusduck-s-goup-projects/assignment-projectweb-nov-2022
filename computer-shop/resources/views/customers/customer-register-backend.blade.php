						...
						<div class="billing-details">
							...
							<form action="{{url('customer/create')}}" method="POST">
								...
								<div class="form-group">
									<input class="input" type="text" name="customerUsername" placeholder="Username">
									<span class="text-danger">@error('customerUsername'){{$message}}@enderror</span>
                                </div>
                                <div class="form-group">
									<input class="input" type="tel" name="customerMail" placeholder="Email">
									<span class="text-danger">@error('customerMail'){{$message}}@enderror</span>
								</div>
								<div class="form-group">
									<input class="input" type="tel" name="customerPassword" placeholder="Password">
									<span class="text-danger">@error('customerPassword'){{$message}}@enderror</span>
								</div>
								<div class="form-group">
									<input class="input" type="text" name="customerFullName" placeholder="User's full name">
								...
								<button type="submit" class="btn button-primary">Register</button>
                                 ...
                                 <a href="access" class="btn btn-danger">Already have an account? Log in</a>
							</form>
						</div>
