                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('category/edit/'.$categories->categoryID)}}" class="btn btn-primary">Edit category</a>
                                                <hr>
                                                <a href="{{url('category/delete/'.$categories->categoryID)}}" class="btn btn-danger">Delete category</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
