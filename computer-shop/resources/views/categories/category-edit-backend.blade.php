                    ...
                    <div class="container-fluid px-4">
                        <div class="row">
                            ...
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item"><a href="/category/index">Categories</a></li>
                            ...
                            <div class="col-md-12">
                                ...
                                @endif
                                    ...
                                    <hr>
                                    <div class="md-3">
                                        <label class="form-label">Category ID: {{$category->categoryID}}</label>   
                                    ...
                                    <a href="{{url('category/index')}}" class="btn btn-danger">Back</a>
